...
echo ""
echo "  1. uv run ~/.claude/tools/memcapture.py --stats"
echo "  2. uv run ~/.claude/tools/memcapture.py --memories"
echo "  3. uv run ~/.claude/tools/memcapture.py --inject --inject-project='claude-engram'"
echo ""
